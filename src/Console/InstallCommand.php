...
class InstallCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $this->call('passport:client', ['--device' => true, '--name' => config('app.name').' Device Code Client']);
    }
    ...
    protected function configureUuids()
    {
        ...
        $this->replaceInFile(database_path('migrations/2023_11_17_000002_create_oauth_device_codes_table.php'), '$table->unsignedBigInteger(\'client_id\');', '$table->uuid(\'client_id\');');
